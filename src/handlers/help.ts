...
const HELP =
  "Use /start in a group to open the moderation menu.\n\n" +
  "Reply to a member with /warn, /mute 10m, or /kick.\n" +
  "Admins can use /setwelcome, /setrules, /setautoactions, /log, and /overview.";
